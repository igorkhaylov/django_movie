...
(function () {
    CKEDITOR.plugins.add("uploadimage", {
        requires: "uploadwidget", onLoad: function () {
            ...
            var d = CKEDITOR.fileTools, c = d.getUploadUrl(b.config, "image");
            if (!c) {
            ...
            b.on("paste", function (m) {
                ...
                var h = m.data, l = document.implementation.createHTMLDocument(""),
                    o = new CKEDITOR.dom.element(l.body), j, f, g;
